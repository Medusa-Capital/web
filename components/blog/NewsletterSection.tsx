      ...
      <div className="max-w-[800px] mx-auto relative">
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundColor: "rgba(27, 26, 100, 0.6)",
              ...
              {status === "success" ? (
                ...
                >
                  <Input
                    ...
                    required
                    className="flex-1 h-12 px-5 rounded-xl border-2 border-[#B9B8EB]/20 bg-[#010052]/50 text-white placeholder:text-[#B9B8EB]/40 focus-visible:border-[#3a54f8] focus-visible:ring-[#3a54f8]/15 transition-all duration-300"
                  />
                  <Button
                    type="submit"
