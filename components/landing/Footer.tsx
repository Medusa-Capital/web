...
export function Footer() {
  ...
  return (
    <footer className="relative py-16 px-6 border-t dark:border-[#B9B8EB]/20 light:border-[#010052]/10 dark:bg-[#010052] light:bg-[#f5f3f0] z-20 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            ...
            />
            <p className="dark:text-[#B9B8EB]/40 light:text-[#3d3d6b]/60 text-sm max-w-sm transition-colors duration-300">
          ...
          <div className="md:text-right">
            <h4 className="dark:text-[#A3A3C3] light:text-[#3d3d6b] font-semibold mb-4 transition-colors duration-300">
            ...
            <div className="flex flex-wrap gap-3 md:justify-end">
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg dark:bg-[#1b1a64]/50 light:bg-[#010052]/5 border dark:border-[#B9B8EB]/20 light:border-[#010052]/15 dark:text-[#B9B8EB]/70 light:text-[#3d3d6b] dark:hover:text-white light:hover:text-[#010052] dark:hover:border-[#B9B8EB]/40 light:hover:border-[#010052]/30 transition-colors"
              >
        ...
        {/* Bottom bar */}
        <div className="pt-6 mt-6 border-t dark:border-[#B9B8EB]/20 light:border-[#010052]/10 flex flex-col md:flex-row items-center justify-between gap-4 transition-colors duration-300">
          ...
          <Link
            href="/privacidad"
            className="dark:text-[#B9B8EB]/40 light:text-[#3d3d6b]/50 text-sm dark:hover:text-white light:hover:text-[#010052] transition-colors"
          >
