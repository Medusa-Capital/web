    ...
    <section className="relative py-[100px] px-6 mt-0">
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="font-[family-name:var(--font-heading)] text-[clamp(36px,6vw,72px)] font-bold dark:text-white light:text-[#010052] leading-tight mb-16 max-w-4xl mx-auto transition-colors duration-300">
