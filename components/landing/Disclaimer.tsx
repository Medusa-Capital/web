export function Disclaimer() {
  return (
    <div className="relative pt-6 border-t border-[rgba(185,184,235,0.2)]">
      <h3 className="font-semibold text-sm mb-3 text-[rgba(185,184,235,0.6)]">
        Disclaimer
      </h3>
      <p className="text-xs leading-[18px] text-[rgba(185,184,235,0.4)]">
