---
title: "Caso $ETHFI: El Protocolo Brillante con Tokenomics Tóxicos"
date: "2025-10-30"
description: "Hoy, en la sección por qué nuestra industria da vergüenza, vamos a destripar el caso de $ETHFI"
tags: ["mercado", "defi", "tecnico", "analisis"]
type: "Educación"
author: "Axel_mnvn"
featured: false
published: true
...
![](/img/blog/caso-ethfi-el-protocolo-brillante-con-tokenomics-toxicos/image-0.png)
...
![](/img/blog/caso-ethfi-el-protocolo-brillante-con-tokenomics-toxicos/image-1.png)
...
![](/img/blog/caso-ethfi-el-protocolo-brillante-con-tokenomics-toxicos/image-2.png)
...
![](/img/blog/caso-ethfi-el-protocolo-brillante-con-tokenomics-toxicos/image-3.png)
...
Velocidad de dilución por trimestre:
→ Q2 2025: +28% QoQ
→ Q3 2025: +53% QoQ (el peor)


Los holders fueron diluidos +161% sin vender nada.


![](/img/blog/caso-ethfi-el-protocolo-brillante-con-tokenomics-toxicos/image-4.png)
...
> Unos fundamenales de negocio fuertes no garantizan buen performance para el token si sus tokenomics están desalineados con los intereses de quienes realmente sostienen la red.
> La inflación no es solo una cuestión secundaria o "aceptable" para incentivar al equipo o los inversores iniciales; en la práctica, puede ser el factor definitivo que convierte una oportunidad ganadora en una inversión tóxica para el retail.
