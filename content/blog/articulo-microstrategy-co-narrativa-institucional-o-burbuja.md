---
title: "ARTÍCULO: MICROSTRATEGY & Co - ¿NARRATIVA INSTITUCIONAL O BURBUJA?"
date: "2025-07-02"
...
![](/img/blog/articulo-microstrategy-co-narrativa-institucional-o-burbuja/image-0.png)
...
![](/img/blog/articulo-microstrategy-co-narrativa-institucional-o-burbuja/image-1.png)
...
![](/img/blog/articulo-microstrategy-co-narrativa-institucional-o-burbuja/image-2.png)
...
- **Bonos convertibles** → para quienes quieren deuda con posibilidad de equity
- **Acciones preferentes** → para quienes buscan rendimiento sin control societario
- **Emisiones primarias** → para captar capital sin intereses
- **Opciones y derivados** → para captar a los más especulativos
...
![](/img/blog/articulo-microstrategy-co-narrativa-institucional-o-burbuja/image-3.png)
...
- Comprar acciones de MSTR equivale a una exposición 1.5x al precio de BTC
...
1. Emite deuda
2. Compra BTC
3. El valor de MSTR sube si sube BTC
4. Puede emitir más deuda a mejores condiciones
5. Compra más BTC
6. Repite
...
- DJT (Trump Media): $2.3B recaudados para comprar BTC
- GameStop (GME): $1.5B en bonos convertibles → 4.710 BTC adquiridos
- SharpLink Gaming (SBET): $425M para comprar ETH
- Upexi: $100M para construir una reserva en SOL
- Meliuz (Brasil): 150M BRL para comprar BTC
- Sol Strategies: crédito y bonos convertibles para adquirir SOL
...
- Los insiders: retienen acciones, inflan la narrativa y venden con prima.
- Los accionistas anteriores al anuncio: multiplican su capital cuando se publica la estrategia.
...
1. **La empresa deja de generar ingresos**:
MSTR aún genera EBITDA positivo con su negocio de software. Sí, relejado a un segundo plano, pero genera cash flow que sirve como aval para no tener que vender BTC.
2. **No puede pagar los intereses de su deuda:**
Esto afecta de a las empresas que se están sumando a esta ola por pura narrativa. Es decir, son empresas zombies las cuales están viendo peligrar su negocio y deciden endeudarse para comprar BTC.
El objetivo es claro:
Emitir deuda → Comprar BTC → Aumento del NAV → Revalorización de la empresa → Insiders, equipo, negocio se ven beneficiados.
...
- Reducción del interés institucional serio
- Rechazo regulatorio a nuevos vehículos de exposición
- Comparaciones con burbujas anteriores (dotcom, ICOs, SPACs sin producto)

**¿Cuál es el escenario de mayor riesgo?**
...
- Registró ingresos de solo 2 millones de euros
- Operó con un **EBITDA negativo de -**€**1.4M**
- Acumuló un **beneficio neto negativo de -**€**3.3M**
- Cerró con un **patrimonio neto negativo estimado en -**€**0.6M**
- Mantuvo **deuda neta de** €**0.9M**, pese a sucesivas ampliaciones de capital
- Cerró cafeterías no rentables y redujo su red a solo 6 locales operativos
...
![](/img/blog/articulo-microstrategy-co-narrativa-institucional-o-burbuja/image-4.png)
...
1. La **posibilidad de negociar líneas de financiación convertible** para ejecutarla.
2. La **delegación al Consejo de la capacidad para realizar ampliaciones de capital excluyendo el derecho de suscripción preferente**, hasta un 20% del capital social.
3. La **creación de mecanismos de retribución variable para intermediarios e incluso miembros del Consejo de Administración**, con un incentivo del 5% sobre el capital captado.

Todo esto acompañado de una política de retribuciones que **vincula directamente los bonus de los consejeros a la capitalización bursátil**:

- Si VANA supera los €20M de capitalización → bonus de 500.000 €
- Si supera €50M → €1M
- Si supera €100M → €2M

![](/img/blog/articulo-microstrategy-co-narrativa-institucional-o-burbuja/image-5.png)
...
- No tienen capacidad de generar flujo para comprar BTC de forma recurrente
- No hay respaldo operativo que sustente la acumulación
- La compra se financia vía ampliaciones de capital o instrumentos similares
