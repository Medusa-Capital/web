...
author: "Axel"
image: "/img/blog/lighter-vs-hyperliquid/image.png"
featured: true
published: true
category: "article"
---
...
![Comparativa de precio](/img/blog/lighter-vs-hyperliquid/image.png)

Vamos al lío.

## ¿Podemos Comparar Hyperliquid & Ligher?

Aquí es donde deberíamos fijar el tiro antes de seguir avanzando. Al igual que no tendría sentido comparar una acción tecnológica con una empresa de uranio, no tiene sentido comparar un DEX de perpetuos ([@Lighter_xyz](https://x.com/@Lighter_xyz)) con el AWS de liquidez ([@HyperliquidX](https://x.com/@HyperliquidX)).

Antes de comparar ambos protocolos, vamos a hacer unas distinciones clave.

### Hyperliquid

> Hyperliquid es una blockchain de alto rendimiento construida con la visión de un sistema financiero abierto totalmente onchain. La liquidez, las aplicaciones de usuario y la actividad comercial se sinergian en una plataforma unificada que, en última instancia, albergará todas las finanzas. House of all Finance
...
![Market Share](/img/blog/lighter-vs-hyperliquid/image-1.png)
...
![Monthly Volume](/img/blog/lighter-vs-hyperliquid/image-2.png)
...
Es cierto que el último repunte fue propiciado, en parte, por el deposito de $50M de [@justinsuntron](https://x.com/@justinsuntron) con el objetivo, presumiblemente, de capturar puntos en la última season pre-TGE.

![TVL Lighter](/img/blog/lighter-vs-hyperliquid/image-3.png)
...
![TVL Hyperliquid](/img/blog/lighter-vs-hyperliquid/image-4.png)
...
- **Hyperliquid** ha generado consistentemente entre **$80M y $110M mensuales** en ingresos por perpetuos desde junio.
Además, su **comisión efectiva (take rate):** Se mantiene saludable entre **2.5 y 3.5 puntos básicos (bps)**. Los usuarios están dispuestos a pagar por la ejecución. Es decir, Hyperliquid tienen Product-Market Fit.

![Hyperliquid Revenue](/img/blog/lighter-vs-hyperliquid/image-6.png)
...
![Take Rate Comparison](/img/blog/lighter-vs-hyperliquid/image-7.png)
...
![Revenue Capture](/img/blog/lighter-vs-hyperliquid/image-8.png)
...
![Comparativa de incentivos](/img/blog/lighter-vs-hyperliquid/image-9.png)

## Fuentes

1. [**Lighter Docs (docs.lighter.xyz)**](https://docs.lighter.xyz/)
2. [**Lighter App**](https://app.lighter.xyz/)
3. [**Lighter Twitter/X (@lighter_xyz)**](https://x.com/lighter_xyz)
4. [**Ericonomic Research sobre Lighter**](https://x.com/ericonomic/status/1968538880724046021)
5. **Hyperliquid Docs ([docs.hyperliquid.xyz](https://docs.hyperliquid.xyz/))**
6. [**Hyperliquid App (hyperliquid.xyz)**](https://hyperliquid.xyz/)
7. [**Hyperliquid Twitter/X (@HyperliquidX)**](https://x.com/HyperliquidX)
8. [**DefiLlama – Hyperliquid TVL & Fees**](https://defillama.com/protocol/hyperliquid)
9. [**Dune Dashboards comunitarios**](https://dune.com/)
