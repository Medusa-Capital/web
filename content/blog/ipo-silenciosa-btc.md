---
title: "La IPO Silenciosa de BTC: ¿Tiene sentido?"
date: "2025-11-04"
description: "Análisis profundo sobre por qué Bitcoin consolida mientras TradFi alcanza máximos históricos. Exploramos la tesis de la 'IPO silenciosa' y qué nos dicen las métricas onchain."
tags: ["bitcoin", "analisis", "institucional", "onchain"]
author: "Axel"
image: "/img/blog/ipo-silenciosa-btc/image.png"
featured: true
published: true
category: "article"
---
...
LINK al artículo: [https://x.com/Axel_Mnvn/status/1980218724037648676](https://x.com/Axel_Mnvn/status/1980218724037648676)
...
Lo primero de todo es entender el punto del mercado en el que nos...
...
LINK: [https://visserlabs.substack.com/p/bitcoins-silent-ipo-why-this-consolidation](https://visserlabs.substack.com/p/bitcoins-silent-ipo-why-this-consolidation)
...
> El comportamiento de Bitcoin en octubre ha sido muy positivo a pesar de underperformear los mercados tradicionales. Bitcoin está estructuralmente más saludable que el mercado de acciones estadounidense en este momento.
...
Bitcoin cerró octubre de 2025 con un desempeño que no podría ser más paradójico. Mientras que el $SPX alcanzaba nuevos máximos históricos, el $NDX lideraba con ganancias sostenidas, y el Oro rompía records de precio, Bitcoin se consolidó lateralmente en un rango estrecho entre $100K y $125K.

**El rendimiento de octubre en contexto:**
...
![Comparativa de rendimiento](/img/blog/ipo-silenciosa-btc/image.png)
...
![Distribución de holders](/img/blog/ipo-silenciosa-btc/image-1.png)

## La Distribución en números (Onchain)

### El Cost Basis vs Precio Actual

Si observamos la métrica de **Realized Price**, vemos el precio promedio al que todos los Bitcoin fueron originalmente comprados:
...
![Realized Price](/img/blog/ipo-silenciosa-btc/image-2.png)

## Las Reservas en Exchanges
...
![Exchange Reserves](/img/blog/ipo-silenciosa-btc/image-3.png)
...
![MVRV Ratio](/img/blog/ipo-silenciosa-btc/image-4.png)

### NUPL (Net Unrealized Profit/Loss): La divergencia clave

Este gráfico ya es habitual en la comunidad. El NUPL muestra una divergencia que lo dice todo. A pesar de que el precio sube, el NUPL forma **máximos menores**. Esto significa:
...
![NUPL](/img/blog/ipo-silenciosa-btc/image-5.png)
...
![Coin Days Destroyed](/img/blog/ipo-silenciosa-btc/image-6.png)
...
![ETF AUM](/img/blog/ipo-silenciosa-btc/image-7.png)
...
![Flujos ETF](/img/blog/ipo-silenciosa-btc/image-8.png)

## El Contraste con TradFi: Concentración vs Distribución

Aquí es donde la perspectiva de nuestro colaborador [@diegopuertas](https://x.com/diegopuertas) cobra relevancia. Mientras Bitcoin está en **distribución ordenada**, TradFi está en **concentración extrema**.
...
![S&P 500 concentración](/img/blog/ipo-silenciosa-btc/image-9.png)
...
Es curioso, pero Bitcoin está **estructuralmente más saludable** que el mercado de acciones estadounidense en este momento.

![Comparativa BTC vs TradFi](/img/blog/ipo-silenciosa-btc/image-10.png)
...
![CTA final](/img/blog/ipo-silenciosa-btc/image-11.png)
